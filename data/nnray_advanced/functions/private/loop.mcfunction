...
execute positioned ~-0.5 ~-0.25 ~-0.5 as @e[dx=0,dy=0,dz=0,tag=nnray_target,tag=!nnray_shooter,tag=!nnray_hit,tag=!nnray_hitbox,tag=!nnray_hitbox_select] run function nnray:private/hit
